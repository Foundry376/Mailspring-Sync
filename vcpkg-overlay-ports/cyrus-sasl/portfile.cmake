# Cyrus SASL overlay port - without GSSAPI/Kerberos for x86-windows compatibility
# This port disables GSSAPI to avoid the krb5 dependency which doesn't support x86-windows
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    ...
    vcpkg_install_nmake(
        ...
        OPTIONS
            ...
            # GSSAPI disabled - krb5 doesn't support x86-windows
            GSSAPI=no
            SASLDB=LMDB
    ...
    # Non-Windows builds (Linux, macOS) - disable GSSAPI here too for consistency
